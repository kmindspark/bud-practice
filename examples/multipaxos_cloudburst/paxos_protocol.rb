module PaxosProtocol
    ...
    state do
      ...
      channel :prepare
      channel :promise, [:@addr, :id, :valid, :have_prev_val, :max_prev_id, :max_prev_val, :slot, :ip, :timestamp]
      channel :accept
      channel :accepted
      scratch :majority
      ...
      table :all_advocate_val, [:slot, :id] => [:val] #table
      scratch :max_advocate_val_temp, [:slot] => [:id]
